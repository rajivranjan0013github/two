...
const Videos = () => {
  const videosArr = [
    ...
    "https://player.vimeo.com/progressivehttps://player.vimeo.com/progressive_redirect/playback/689949818/rendition/540p?loc=external&oauth2_token_id=1027659655&signature=cf602155bf49e4e74db6f2ec9d4ecf067fbab44c4295a8950d58ecdb88910882_redirect/playback/690770660/rendition/720p?loc=external&oauth2_token_id=1027659655&signature=3a048039957fd878fc72b809b9a0e5f2102eded879a83e00784ecd3ba5123614",
  ];
    ...
    <Stack direction={["column", "row"]} h={"100vh"}>
      <VStack w={"full"}>
        ...
        <VStack alignItems={"flex-start"} p={8} w="full" overflowY={"auto"}>
          ...
          <Text>this is a sample video and it also known as description</Text>
        </VStack>
      </VStack>
      <VStack
        w={["full", "xl"]}
